...
sudo certbot --standalone certonly --expand --domains "sitesearch.cloud, www.sitesearch.cloud, dev.sitesearch.cloud, api.sitesearch.cloud, ci.sitesearch.cloud, main.sitesearch.cloud, test.sitesearch.cloud"
