...
sudo certbot --webroot certonly -w /var/www/letsencrypt --expand --domains "sitesearch.cloud, www.sitesearch.cloud, dev.sitesearch.cloud, api.sitesearch.cloud, ci.sitesearch.cloud, about.sitesearch.cloud, info.sitesearch.cloud"
