...
#docker run -d --name $DOCKER_IMAGE_NAME -p 443:8001 -v ~/srv/$DOCKER_IMAGE_NAME:/data intrafind/$DOCKER_IMAGE_NAME:$DOCKER_TAG
...
powershell release-as-docker-container.ps1
